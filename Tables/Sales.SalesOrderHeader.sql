...
CREATE TABLE [Sales].[SalesOrderHeader] (
		...
		[Commentsdf]                 [nvarchar](128) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
		[rowguid]                    [uniqueidentifier] NOT NULL ROWGUIDCOL,
		[ModifiedDatedfs]            [datetime] NOT NULL
) ON [PRIMARY]
GO
...
GO
EXEC sp_addextendedproperty N'MS_Description1', N'Primary key', 'SCHEMA', N'Sales', 'TABLE', N'SalesOrderHeader', 'INDEX', N'PK_SalesOrderHeader_SalesOrderID'
GO
ALTER TABLE [Sales].[SalesOrderHeader]
	ADD
...
GO
EXEC sp_addextendedproperty N'MS_Description1', N'Primary key', 'SCHEMA', N'Sales', 'TABLE', N'SalesOrderHeader', 'CONSTRAINT', N'CK_SalesOrderHeader_DueDate'
GO
ALTER TABLE [Sales].[SalesOrderHeader]
...
ALTER TABLE [Sales].[SalesOrderHeader]
	...
	DEFAULT (getdate()) FOR [ModifiedDatedfs]
GO
...
GO
EXEC sp_addextendedproperty N'MS_Description', N'Sales representative comments.', 'SCHEMA', N'Sales', 'TABLE', N'SalesOrderHeader', 'COLUMN', N'Commentsdf'
GO
...
GO
EXEC sp_addextendedproperty N'MS_Description', N'Date and time the record was last updated.', 'SCHEMA', N'Sales', 'TABLE', N'SalesOrderHeader', 'COLUMN', N'ModifiedDatedfs'
GO
